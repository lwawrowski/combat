...
test_that("check results", {
  expect_equal(hp_check(player_id = "ID9", opponent_id = "ID7", units_data = units_game, dist_matrix_data = dist_matrix), 46.585)
  expect_equal(hp_check(player_id = "ID9", opponent_id = "ID352", units_data = units_game, dist_matrix_data = dist_matrix), 0)
})
